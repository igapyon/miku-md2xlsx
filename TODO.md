...
- Resume note as of 2026-05-17:
  ...
  - Final verification and handoff summary are updated. Next practical restart
    point: review the accumulated diff and commit it, or perform a first
    release-tag workflow dry run on GitHub.
...
- Add more real-document Markdown block coverage after the current focused
  escaped pipe, empty cell, and multiline-like table cell assertions.
...
- Expand structured `.xlsx` assertions further when new generated package
  contracts are added.
- Review the GitHub Release asset workflow after the first release tag run.
